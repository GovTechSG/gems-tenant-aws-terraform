...
resource "aws_instance" "GEMS_Tenant_Kong_Gateway" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo docker run --rm -e \"KONG_DATABASE=postgres\" -e \"KONG_PG_USER=postgres\" -e \"KONG_PG_PASSWORD=Pass1234\" -e \"KONG_PG_HOST=${aws_db_instance.GEMS-Tenant-DB.endpoint}\" -e \"KONG_PASSWORD=Pass1234\" -e \"KONG_LICENSE_DATA=$KONG_LICENSE_DATA\" kong-ee kong migrations bootstrap",
      "sudo docker run --rm -e \"KONG_DATABASE=postgres\" -e \"KONG_PG_USER=postgres\" -e \"KONG_PG_PASSWORD=Pass1234\" -e \"KONG_PG_HOST=${aws_db_instance.GEMS-Tenant-DB.endpoint}\" -e \"KONG_PASSWORD=Pass1234\" -e \"KONG_LICENSE_DATA=$KONG_LICENSE_DATA\" kong-ee kong migrations up",
      "sudo docker rm -f kong-ee",
      "sudo docker run -d --name kong-ee --restart always -e \"KONG_DATABASE=postgres\" -e \"KONG_PG_USER=postgres\" -e \"KONG_PG_PASSWORD=Pass1234\" -e \"KONG_PG_HOST=${aws_db_instance.GEMS-Tenant-DB.endpoint}\" -e \"KONG_LICENSE_DATA=$KONG_LICENSE_DATA\" -e \"KONG_PROXY_ACCESS_LOG=/dev/stdout\" -e \"KONG_PROXY_ERROR_LOG=/dev/stderr\" -e \"KONG_PROXY_LISTEN=0.0.0.0:8443, 0.0.0.0:8000 ssl\" -p 8000:8000 kong-ee"
    ]
  }
}
#-----------------------------------------------------------------------------------------------------------------------
resource "aws_instance" "GEMS_Tenant_Kong_Manager_And_Admin_API" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo docker run --rm -e \"KONG_DATABASE=postgres\" -e \"KONG_PG_USER=postgres\" -e \"KONG_PG_PASSWORD=Pass1234\" -e \"KONG_PG_HOST=${aws_db_instance.GEMS-Tenant-DB.endpoint}\" -e \"KONG_PASSWORD=Pass1234\" -e \"KONG_LICENSE_DATA=$KONG_LICENSE_DATA\" kong-ee kong migrations up",
      "sudo docker rm -f kong-ee",
      "sudo docker run -d --name kong-ee --restart always -e \"KONG_DATABASE=postgres\" -e \"KONG_PG_USER=postgres\" -e \"KONG_PG_PASSWORD=Pass1234\" -e \"KONG_PG_HOST=${aws_db_instance.GEMS-Tenant-DB.endpoint}\" -e \"KONG_LICENSE_DATA=$KONG_LICENSE_DATA\" -e \"KONG_ENFORCE_RBAC=on\" -e \"KONG_ADMIN_LISTEN=0.0.0.0:8001, 0.0.0.0:8444 ssl\" -e \"KONG_ADMIN_GUI_AUTH=basic-auth\" -e \"KONG_ADMIN_GUI_SESSION_CONF=$KONG_ADMIN_GUI_SESSION_CONF\" -e \"KONG_AUDIT_LOG=on\" -e \"KONG_ADMIN_GUI_URL=https:\/\/tenant-manager.gemsapi.io\" -e \"KONG_ADMIN_API_URI=https:\/\/tenant-admin-api.gemsapi.io\" -e \"KONG_PORTAL=on\" -e \"KONG_PORTAL_GUI_PROTOCOL=https\" -e \"KONG_PORTAL_GUI_HOST=tenant-dev-portal.gemsapi.io\" -e \"KONG_PORTAL_API_URL=httpsz:\/\/tenant-dev-api.gemsapi.io\" -e \"KONG_ADMIN_ACCESS_LOG=/dev/stdout\" -e \"KONG_ADMIN_ERROR_LOG=/dev/stderr\" -p 8001-8002:8001-8002 kong-ee"
    ]
  }
...
resource "aws_instance" "GEMS_Tenant_Kong_Dev_Portal_And_Dev_Portal_API" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo docker run --rm -e \"KONG_DATABASE=postgres\" -e \"KONG_PG_USER=postgres\" -e \"KONG_PG_PASSWORD=Pass1234\" -e \"KONG_PG_HOST=${aws_db_instance.GEMS-Tenant-DB.endpoint}\" -e \"KONG_PASSWORD=Pass1234\" -e \"KONG_LICENSE_DATA=$KONG_LICENSE_DATA\" kong-ee kong migrations up",
      "sudo docker rm -f kong-ee",
      "sudo docker run -d --name kong-ee --restart always -e \"KONG_DATABASE=postgres\" -e \"KONG_PG_USER=postgres\" -e \"KONG_PG_PASSWORD=Pass1234\" -e \"KONG_PG_HOST=${aws_db_instance.GEMS-Tenant-DB.endpoint}\" -e \"KONG_PORTAL_GUI_PROTOCOL=https\" -e \"KONG_LICENSE_DATA=$KONG_LICENSE_DATA\" -e \"KONG_ENFORCE_RBAC=on\" -e \"KONG_PORTAL_AUTH=basic-auth\" -e \"KONG_PORTAL=on\" -e \"KONG_PORTAL_SESSION_CONF=$KONG_PORTAL_SESSION_CONF\" -e \"KONG_AUDIT_LOG=on\" -e \"KONG_PORTAL_GUI_HOST=tenant-dev-portal.gemsapi.io\" -e \"KONG_PORTAL_API_URL=https:\/\/tenant-dev-api.gemsapi.io\" -p 8003-8004:8003-8004 kong-ee"
    ]
  }
